...
console.log(
    decodeMessage(
        `gAB3EgADAAFwEgACAAFwEgAEAAZibG9ja3MRAAESAAMAAmhwBAAABB0AAWkEAAAAFwABagQAAAAIAAJpZAUAAAAAAORPJgACZWMEAAAAAAAGZW5lcmd5BAAAAF0AAWMIAA1TVEFSVF9FWFBMT0RFAAFhAwANAAFjAgE=`
    )
);
