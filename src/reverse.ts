...
console.log(
    decodeMessage(
        "gACgEgADAAFjAgEAAWEDAA0AAXASAAMAAWMIAAlTVEFSVF9QVkUAAXIE/////wABcBIABAAEZGF0YRIAAgAGc2xvZ2FuCAAKZ29sZF9taW5lcgAEbW9kZQQAAAABAAJpZAQAAAAKAARoYXNoCAAgMzE4Y2E5ZjY2ODRiNzgwMmQ5MjgyN2MyMjAwMDJkZjYACXRpbWVzdGFtcAUAADoEnq/yIw=="
    )
);
